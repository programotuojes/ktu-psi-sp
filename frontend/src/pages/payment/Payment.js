      ...
      <Grid container className={classes.root} cols={3}>
        ...
        <Grid item xs>
          ...
          <RadioGroup name="delivery" value={valueDelivery} onChange={handleChangeDelivery}>
            <FormControlLabel value="shop" control={<Radio />} label="Nemokamas atsiėmimas parduotuvėje. Rotušės a.15 Kaunas" />
            <FormControlLabel value="courier" control={<Radio />} label="Pristatymas į namus per kurjerio tarnybą. Kaina 2.5€" />
            <FormControlLabel value="postOffice" control={<Radio />} label="Atsiėmimas Lietuvos pašto skyriuje. Kaina 2.2€" />
          </RadioGroup>
        </Grid>
        <Grid item xs>
