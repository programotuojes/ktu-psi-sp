    ...
    <>
      ...
      <Container maxWidth="lg" className={classes.container}>
        <Grid container alignItems="center" justify="center" spacing={0}>
          <Grid item xs={12}>
          <img src={logo} className={classes.images}></img>
          </Grid>
          <Grid item xs={12}>
      ...
      <Grid container alignItems="center" spacing={0} justify="center" className={classes.gridContainer}>
        <Grid item sm={4}>
          <img src={first} className={classes.images} style={{width:"100%"}}/>
        </Grid>
        <Grid item sm={4}>
          <img src={second} className={classes.images} style={{width:"100%"}}/>
        </Grid>
        <Grid item sm={4}>
          <img src={third} className={classes.images} style={{width:"100%"}}/>
        </Grid>
      </Grid>
      <Container maxWidth="lg" className={classes.gridContainer}>
        ...
        <Grid item xs={12}>
            <Typography variant="h3" className={classes.headers}>
              THE WALL - IŠ NAUJO APIBRĖŽTAS TIPIŠKO LIETUVIO STEREOTIPAS PASINAUDOJANT GATVĖS MENO GALIA
            </Typography>
          </Grid>
        </Grid>
      </Container>
      <Grid container alignItems="center" spacing={0} justify="center" className={classes.gridContainer}>
        <Grid item sm={6}>
          <img src={fourth} className={classes.images} style={{width:"100%"}}/>
        </Grid>
        <Grid item sm={6}>
          <img src={fifth} className={classes.images} style={{width:"100%"}}/>
        </Grid>
      </Grid>
      <Container maxWidth="lg" className={classes.gridContainer}>
      <Grid container alignItems="center" justify="center" spacing={0}>
